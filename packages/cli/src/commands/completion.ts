 ...
 * the shell scripts can consume.
 *
 * NOTE: an earlier revision filtered out a `help` subcommand because
 * commander auto-generated one and we didn't want it cluttering tab
 * completion. After we registered our own `cfcf help` (5.8 PR2) +
 * `cfcf help assistant` (5.8 PR4), the filter became actively wrong.
 * Removed 2026-04-27.
 */
